...
module.exports.showMessageBox = deprecate.promisify(module.exports.showMessageBox, ({ response, checkboxChecked }) => [response, checkboxChecked])
module.exports.showOpenDialog = deprecate.promisify(module.exports.showOpenDialog, ({ filePaths, bookmarks }) => [filePaths, bookmarks])
module.exports.showSaveDialog = deprecate.promisify(module.exports.showSaveDialog, ({ filePath, bookmarks }) => [filePath, bookmarks])
